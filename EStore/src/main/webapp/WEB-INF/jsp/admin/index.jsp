...
< <div class="container cart"> 
	...
	<table id="table" style="text-align: center;" width="100%" style="table-layout:fixed;"> 
				<tr>
				 <th>用户名</th>
				 <th>姓名</th>
				 <th>年龄</th>
	...
	$.ajax({
		...
		//	alert(result.error_msg);
			...
			//	alert(admin.role.role);
		    	...
		    	$("#age").html(admin.age);
		    	$("#sex").html(admin.sex);
		    	$("#role").html(admin.role.role);		    		    	
		    	$("#status").html(admin.role.id==1?"在职":"离职");
			})
		}
	})
})
