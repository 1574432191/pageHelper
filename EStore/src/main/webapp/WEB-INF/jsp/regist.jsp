	...
	<div class="span5">
		<div class="logo">
			<a href="http://localhost:8080/mango/">
				<img src="${root}/image/logo.png" alt="">
			</a>
		</div>
	</div>
	<div class="span9">
<div class="headerAd">
	...
	<div class="span10 last">
		<div class="topNav clearfix">
			<ul>
				...
				<li id="headerRegister" class="headerRegister" style="display: list-item;">
					<a href="${root}/user/regist.html">注册</a>|
				</li>
				<li id="headerUsername" class="headerUsername"></li>
				<li id="headerLogout" class="headerLogout">
					<a href="${root }/user/login.html" >[退出]</a>|
				</li>
						<li>
							<a>会员中心</a>
							|
		...
		<div class="cart">
			<a href="${root }/cart/shoppingCard.html">购物车</a>
		</div>
			<div class="phone">
				客服热线:
			...
			<div class="wrap">
				<div class="main clearfix">
					<div class="title">
						...
						<!-- <strong><a href="会员注册 - 手机号注册.htm">【手机号注册】</a></strong> -->
					...
					<form id="registerForm"  method="post" novalidate="novalidate">
						<table>
							...
							<tr>
								...
								<td>
									<input type="text" id="username" name="username" class="text" maxlength="20">	<!-- <span>错误</span> -->
							...
							<tr>
								...
								<td>
									<input type="button" class="submit" id="regist" value="同意以下协议并注册">
								</td>
							</tr>
							<tr>
								<th>&nbsp;
...
<div id="_my97DP" style="position: absolute; top: -1970px; left: -1970px;"><iframe style="width: 190px; height: 191px;" src="" frameborder="0" border="0" scrolling="no"></iframe></div>
...
//		 var sex = $("input[name=sex]:checked").val();
		 ...
		 var code = $("#ucode").val();
//		 alert(birthday+"  "+rePassword+"  "+code)
		 $.ajax({
			 "url":"${root}/user/reg.do",
			"type":"post",
		"dataType":"json",
			 data:{"username":username,"password":password,"rePassword":rePassword,
				 "email":email,"name":name,"sex":sex,"birthday":birthday,"address":address,"code":code},
			success:function(result){
				var code = result.error_code;
	//			alert(code);
				if(code==0){
					$("#error_username").html(result.error_msg);	
				}
				if(code==1){
					$("#error_password").html(result.error_msg);	
				}
				if(code==2){
					$("#error_email").html(result.error_msg);
				}
				if(code==3){
